...
const plainIdle = "bg-primary-light text-primary";
const filterIdle = "bg-primary-light text-primary hover:bg-primary-light-active";
...
<template>
  <button
    ...
    :class="[base, variant === 'plain' ? plainIdle : active ? filterActive : filterIdle]"
    :disabled="disabled"
    type="button"
    @click="emit('toggle')"
  >
